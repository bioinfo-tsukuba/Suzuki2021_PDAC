...
df3 %>%
    ...
    theme_bw() +
    labs(x="log10(N_sending * N_receiving)",
     y="Number of LR pairs detected by NATMI", 
     title = "Detected LR pairs for each cell type pair and each patient") -> g1
...
df3 %>%
    ...
    labs(x="log10(N_sending * N_receiving)",
     y="Number of LR pairs detected by NATMI", 
     title = "Detected LR pairs for each cell type pair and each patient") -> g2
...
df3 %>%
    ...
    labs(x="log10(N_sending * N_receiving)",
     y="Number of LR pairs detected by NATMI", 
     title = "Detected LR pairs for each cell type pair and each patient") -> g3
