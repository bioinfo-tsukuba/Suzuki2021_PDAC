...
df_HMA %>%
  rename("Edge_average_expression_weight" = "Edge average expression weight") %>%
...
# save df_result
write_csv(df_result, "/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HRH/HRH_dfB.csv")

# Convert tidy data into matrix
df_result %>%
  filter(!is.na(Grade)) %>%
  pivot_wider(
    names_from = Grade, values_from = mean_edge_average_ew,
...
# save df_mat
write_csv(df_mat, "/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HRH/HRH_dfC.csv")

# Check
str(mat1)

# 図B-1
pdf("/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HRH/HRH_HM/HRH_HMB.pdf")
...
# 図B-1 text annotation
pdf("/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HRH/HRH_HM/HRH_HMB_textanno.pdf",
  width = 10, height = 30
)
...
# make directory
dir.create("/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HRH/HRH_HM_Grade/")
...
for (ctp in ctps) {
  ...
  pdf_name <- paste0("/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HRH/HRH_HM_Grade/", "heatmap_", gsub("->", "-", ctp), ".pdf")
  pdf(pdf_name)
...
pdf_name <- ("/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HRH/HRH_HMB_by_grade.pdf")
