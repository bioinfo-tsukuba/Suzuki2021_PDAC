...
# [HM-B] HR>1 の LRペアのヒートマップ
df %>% filter(meanHR >= 1) %>% select(LR) -> HMB
...
left_join(HMB, df_01, by = "LR") -> df_01
unique(df_01$LR)
...
left_join(HMB, df_02, by = "LR") -> df_02
unique(df_02$LR)
...
left_join(HMB, df_03, by = "LR") -> df_03
unique(df_03$LR)
...
left_join(HMB, df_04, by = "LR") -> df_04
unique(df_04$LR)
...
left_join(HMB, df_05, by = "LR") -> df_05
unique(df_05$LR)
...
left_join(HMB, df_06, by = "LR") -> df_06
unique(df_06$LR)
...
left_join(HMB, df_07, by = "LR") -> df_07
unique(df_07$LR)
...
left_join(HMB, df_08, by = "LR") -> df_08
unique(df_08$LR)
...
left_join(HMB, df_09, by = "LR") -> df_09
unique(df_09$LR)
...
left_join(HMB, df_10, by = "LR") -> df_10
unique(df_10$LR)

# Bind
bind_rows(df_01, df_02, df_03, df_04, df_05, df_06, df_07, df_08, df_09, df_10) -> df_result

write_csv(df_result, "/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/NATMI_LR_patients_HMB.csv")

# 基本の表
df_result %>% select(LR, cell_type_pair, Patient) -> df_common_LR
unique(df_common_LR$LR)
write_csv(df_common_LR, "/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/NATMI_common_LR_patients_HMB.csv")
...
write_csv(df_summary, "/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HMB_summary_number_of_patient.csv")
unique(df_summary$LR)

# read csv
dfdf <- read_csv("/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HMB_summary_number_of_patient.csv")
unique(dfdf$LR)
...
pdf("/Users/sayakasuzuki/Desktop/SSD/results/NATMI_each_patient/HMB_heatmap_all_patients.pdf") 
